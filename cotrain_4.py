...
def get_args():
    ...
    parser.add_argument('--output-directory', help='output directory parent', type=str, default='results_new/co_models_4/',)

    args = parser.parse_args()

    return args

def train_alone_model(model, base_model_1, base_model_2, base_model_3, epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        penalty = (penalty_1 + penalty_2 + penalty_3) / 3
...
if __name__ == '__main__':
    ...
    co_seeds = [8859, 9876, 37, 5639, 8976]
     
    
     
    for base_seed_1, base_seed_2, base_seed_3, co_seed in zip(base_seeds_1, base_seeds_2, base_seeds_3, co_seeds):
        ...
        for dataset in args.datasets:
            ...
            output_directory = os.getcwd() + '/' + output_directory + f'co_seed_{co_seed}_base_seed_{base_seed_3}_{base_seed_2}_{base_seed_1}/' + dataset + '/'
            ...
            for epoch in range(epochs):
                ...
                train_loss, ce_loss, loss_div_feat, train_acc = train_alone_model(clf, base_model_1, base_model_2, base_model_3, epoch)
